...
class CarModelSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        try {
            foreach ($carList as $NameCar => $modelsData) {
                foreach ($modelsData as $modelCar) {


                    $brandID = Brand::getIdByName($NameCar)->first()->id;
                    ...
                    if ($brandID) {
                        ...
                        $model->name  = $modelCar["name"];
                        $model->year_ref = $modelCar['year'];
                        $model->save();
